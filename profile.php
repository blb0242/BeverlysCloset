			...
			<div class="container">
			  <ul class="right hide-on-med-and-down">
				...
				<li id="cart-list-item">
					<a class="dropdown-trigger" href="#!" data-target="cartDropDown">
						<i  class="shopping-cart-fly material-icons left">shopping_cart</i>
							Cart  
						<span class="cartItems badge white black-text"></span>
					</a>
				</li>
				...
				<div class="grid-item">
				  <div class="card hoverable">
					<div class="item card-image">
					  ...
					  <button pid="<?php echo $pro_id; ?>" class="add-to-cart btn-floating halfway-fab waves-effect waves-light"><i class="material-icons">add</i></button>
					</div>
          ...
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">Thank you for shopping with Beverly's Closet. I hope you find something you will love to wear around town. </p>
              </div>
