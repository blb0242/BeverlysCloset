...
include 'db.php';
  ...
  $chartQuery = "SELECT product_cat, COUNT(*) as total
  FROM products
  GROUP BY product_cat";

  $labels =  array();
  $totals =  array();
  $chart = $conn->query($chartQuery);
  while ($chartRow = $chart->fetch_array()) {
    $cat = $chartRow['product_cat'];
    $chartQuery2 = "SELECT * FROM categories WHERE cat_id = '$cat'";
    $chart2 = $conn->query($chartQuery2);
    $chartRow2 = $chart2->fetch_array();
    array_push($labels,$chartRow2['cat_title']);
    array_push($totals,$chartRow['total']);
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class=" statistic__item statistic__item--blue">
                              ...
                              <a href="inventory.php">
                                ...
                                <h2 class="number"><?php echo $productCount; ?> <span class="label label-primary">New</span></h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div class="chart-percent-2">
                                <h3 class="title-3 m-b-30">Products by %</h3>
                                ...
                                $colors = array('blue', 'red', 'green', 'orange');
                                  foreach ($labels as $label => $values) {
                                    echo '<div class="chart-note">
                                        <span class="dot dot--'.$colors[$label].'"></span>
                                        <span>'.$values.'</span>
                                    </div>';
                                  }
